  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;CHARLY;;;\nFN:CHARLY\nORG: CHARLY \nTITLE:\nitem1.TEL;waid=593960070183:+593 960 701 83\nitem1.X-ABLabel:CHARLY\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:CHARLYFLOW👑\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, { contacts: { displayName: 'CHARLY FLOW', contacts: [{ vcard }] } }, { quoted: callmsg });
